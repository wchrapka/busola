...
export function Editor({
  ...
  return (
    <div>
      <div
        ref={divRef}
        style={{ width: 800, height: 600, border: '1px solid #d9d9d9' }}
      />
...
function setAutocompleteOptions(uriString) {
    ...
    schemas: [
      {
        ...
        uri: 'https://kubernetes.io/docs/concepts/workloads/controllers/job/',
